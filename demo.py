...
with col1:
    st.header(':green[Data collection zone]')
    channel_id = st.text_input('**Enter the channel_id**')
    st.write('''Get data and stored it in the MongoDB database, click below **:blue['Get data and stored']**.''')
    ...
    if Get_data or st.session_state.Get_state:
        ...
        # Function to Get  video_ids using channel playlist Id
        ...
        # Function to Get Videos data and comment data from video ids
        ...
        for i, video in enumerate (video_data):
            ...
            if video['comment_threads'] is not None:
                ...
                for index, comment_thread in enumerate(video['comment_threads']['items']):
                    ...
                    comment_published_at = comment['publishedAt'].replace("T"," ").replace("Z"," ")
     ...
     #MongoDB connection       
        ...
        client = pymongo.MongoClient("mongodb://username:password@ac-ixeh77p-shard-00-00.isyz2en.mongodb.net:27017,ac-ixeh77p-shard-00-01.isyz2en.mongodb.net:27017,ac-ixeh77p-shard-00-02.isyz2en.mongodb.net:27017/?ssl=true&replicaSet=atlas-10l0qz-shard-0&authSource=admin&retryWrites=true&w=majority")
...
#Migration
with col2:
    st.header(':green[Data Migrate zone]')
    ...
    st.write('''Migrate to MySQL database from MongoDB database, click below **:blue['Migrate to MySQL']**.''')
    ...
    if Migrate or st.session_state_migrate_sql:
      ...
      #Data convertion
       ...
       #Data migrated to SQL
        ...
        engine = create_engine('mysql+mysqlconnector://root:mithu123@localhost/youtube_db', echo=False)
...
if Check_channel:
   # Create database connection
    engine = create_engine('mysql+mysqlconnector://user:password@localhost/youtube_db', echo=False)
...
connect_for_question = pymysql.connect(host='localhost', user='root', password='mithu123', db='youtube_db')
